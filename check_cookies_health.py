...
def main():
    ...
    if check_cookies():
        ...
        send_telegram(
            ...
            '<b>Para renovar:</b>\n'
            '1. No Mac, feche o Chrome (Cmd+Q)\n'
            '2. Execute: <code>yt-dlp --cookies-from-browser chrome --cookies youtube_cookies.txt --skip-download "https://youtube.com"</code>\n'
            '3. Filtre e converta para base64\n'
            '4. Atualize YOUTUBE_COOKIES no Dokploy'
        )
        sys.exit(1)
